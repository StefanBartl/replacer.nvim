...
Ziel: Find/Replace wie in VSCode
- zwei inputs - old / new - übereinander, die live geändert werden können
- Entrylist
  - mit tab selected
  - mit alt enter sofort geändert
- Preview
...
* Regex-Modus mit Hilfen
  Umschalter „literal/regex“, Escaping-Helfer, ok-Panel für Pattern, Backreferences im Replacement.
